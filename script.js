...
(function(){
 ...
 debugger
  clothing.map((cloths,index)=>{
    ...
    clothList.append(preview);
    clothList.append(proName);
...
//     const accessorie = productList.filter((value)=>value.isAccessory)
//    debugger
//    accessorie.map((accs,index)=>{

//       const clothList = document.createElement("div");
//       clothList.classList = "card";
  
//       const preview = document.createElement("img");
//       preview.setAttribute("src", accs.preview);
  
//       const proName = document.createElement("h3");
//       proName.innerHTML = accs.name
  
//       const brand = document.createElement("h4")
//       brand.innerHTML = accs.brand
    
//       const price = document.createElement("h5")
//       price.innerHTML = accs.price
...
// function createGrid(list, heading) {
//   // create a section for a grid;
//   // create h2 tag for headline
//   // assign heading to h2;
//   //append h2 in  section
//   // create a div(list wrapper) for entire list
//   // loop given list and create a card for each iteration;
//   // for each iteration:
//   // create an article for card
//   // create preview and set each_item.preview to src;
//   // create a p tag for card title and assign title to inner html
//   // create a span tag for brand and asssign brand to innerhtml
//   // create p tag for price
//   // append everthing in article with proper classLists
//   // append article to list wrapper div;
//   // append list wrapper in section;
//   // return section
// }

// target main container ;

// const clothingSection = createGrid(clothings,"Clothing for Men and Women");

// const accessorySection = createGrid(accessories,"Accessories for Men and Women");

// append clothingSection in main container
// append accessorySection in main container
